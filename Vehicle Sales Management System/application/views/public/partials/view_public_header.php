...
<div class="header">
	<div class="header-top">
		...
		<div class="container">
			<div class="head-top">
				<div class="logo">
					<h1><a href="<?= base_url(); ?>"><img src="./assets/images/vmlg.png" width="95" alt=""></a></h1>
				</div>
		  <div class=" h_menu4">
				<ul class="memenu skyblue">
					<li><a class="color8" href="<?= base_url(); ?>">Home</a></li>	
					<li><a class="color4" href="#">Contact</a></li>
					<li><a class="color4" href="#">About</a></li>
					<li><a class="color4" href="<?php echo base_url('login'); ?>">Login Panel</a></li>
			  </ul> 
			</div>
